...
tests_apphomekey = [
  ...
  #  "api_type": "POST",
  #  "api_base_url": "apis/bjzlhr11aevxwik0pf0x/v3/homeslug/get/1/1/303",
  ...
  #    "code": "200",
  #    "rowcount":20,
  #    "item\\0\primary_category\\0\slug": "Business",
  #    "specific":False,
  #  },
  #  "api_store": {
  #    "response": {
  #      "primary_category\\0\slug":"slug",
  #    },
  #  },
  #  "output_mode": 'w',
  # },
  ...
  ## 2-1. 2=Featured, 379=Interviews, Status: Done
  {
   ...
   "api_type": "POST",
   "api_base_url": "apis/bjzlhr11aevxwik0pf0x/v3/homeslug/get/2/1/379",
   "api_function": "apphomekeyslug",
   "api_params": {
     "id_slug": "2",
     "subId_slug": "379",
